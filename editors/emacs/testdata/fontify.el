...
(defun unobin-test-fontify (grammar-dir mode-path sample-path)
  ...
  (with-temp-buffer
    ...
    (dolist (check '(("highlight sample" 0 font-lock-comment-face)
                     ...
                     ("assets" 0 font-lock-keyword-face)
                     ...
                     ("PriceClass_200" 0 font-lock-string-face)
                     ("after-wrapped" 0 font-lock-property-name-face)
                     ("42" 0 font-lock-constant-face)
                     ...
                     ("asset.source" 0 font-lock-builtin-face)
