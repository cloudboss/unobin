...
var inlineUBGreenlist = map[string]bool{
	...
	"pkg/compile/compile_test.go":                  true,
	...
	"pkg/deps/manifest_test.go":                    true,
	"pkg/deps/scan_test.go":                        true,
	"pkg/deps/verify_test.go":                      true,
	"pkg/lang/blocks_test.go":                      true,
	"pkg/lang/constraints_test.go":                 true,
	"pkg/lang/inputs_test.go":                      true,
	"pkg/lang/sensitive_test.go":                   true,
	...
	"pkg/resolve/composite_test.go":                true,
	"pkg/resolve/library_test.go":                  true,
	"pkg/resolve/remote_test.go":                   true,
	"pkg/resolve/resolve_test.go":                  true,
	"pkg/resolve/syntax_extract_test.go":           true,
	"pkg/resolve/ubwalk_test.go":                   true,
	"pkg/resolve/visibility_test.go":               true,
	...
	"pkg/runner/schema_outputs_test.go":            true,
	"pkg/runner/state_config_test.go":              true,
	"pkg/runtime/apply_configuration_test.go":      true,
	"pkg/runtime/apply_contract_test.go":           true,
	"pkg/runtime/apply_drain_test.go":              true,
	"pkg/runtime/apply_empty_inputs_test.go":       true,
	"pkg/runtime/apply_error_test.go":              true,
	"pkg/runtime/apply_events_test.go":             true,
	"pkg/runtime/apply_graph_test.go":              true,
	"pkg/runtime/apply_lock_test.go":               true,
	"pkg/runtime/apply_plan_test.go":               true,
	"pkg/runtime/apply_reconcile_test.go":          true,
	"pkg/runtime/apply_schedule_test.go":           true,
