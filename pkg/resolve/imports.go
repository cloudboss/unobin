...
// filled in from project-lock.ub as the walk descends. ProjectSubdir and PackageSubdir
// are set after project or project-lock lookup when the owning project differs from
